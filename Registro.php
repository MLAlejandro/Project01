...
<div class="main-block">
    ...
    <div class="pages-indent">
		        <form action="http://www.misterguau.com/index.php/customer/account/createpost/" method="post" id="form-validate" onsubmit="return validate_form ( );">
...
<input id="telefono" name="amcustomerattr[telefono]" value="" class=" required-entry required-entry input-text" type="tel"/>

<div style="padding: 4px;"></div></span>
<span class="field-row">
<label for="otros">Direccion</label><br />
<input id="otros" name="amcustomerattr[otros]" value="" class=" input-text required" type="text"/>
<div style="padding: 4px;"></div></span>
</fieldset></div>
            </div>
        </li>
			...
			<br>
                ...
                <label for="allow_privacy"><a href="http://www.misterguau.com/index.php/privacy/" target="_blank">ACEPTO T&Eacute;RMINOS DE USO y protecci&oacute;n de datos</a><span class="required">*</span></label>
          
			
            <p class="required">* Campos requeridos</p>
            <div class="buttons-set">
                <button class="button" type="submit"><span><span><span>Enviar</span></span></span></button>
            </div>
